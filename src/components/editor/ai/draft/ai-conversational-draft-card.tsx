...
import { getDraftPlaybook, listDraftPlaybooks } from '@/lib/editor/ai/draft/draft-playbooks'
import type {
  AskDraftPlan,
  AskDraftQuestion,
...
import { openGuidedDraft } from '@/lib/editor/ai/draft/guided-draft-events'
