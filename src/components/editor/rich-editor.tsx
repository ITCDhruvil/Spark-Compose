...
import { EditorToolbar } from './core/toolbar/editor-toolbar'
import { TableMenu } from './smart/tables/table-menu'
import { ImageMenu } from './core/images/image-menu'
import { AiSelectionMenu } from './ai/selection/ai-selection-menu'
import { SelectionFormatMenu } from './smart/selection-format/selection-format-bar'
import { AiConversationalDraftCard } from './ai/draft/ai-conversational-draft-card'
import { AiDraftEnhancePanel } from './ai/draft/ai-draft-enhance-panel'
import { AiGuidedDraftPanel } from './ai/draft/ai-guided-draft-panel'
import { OPEN_DRAFT_ANYTHING_EVENT } from '@/lib/editor/ai/draft/draft-anything-events'
import { resolveAiEnabled, type RichEditorAiConfig } from '@/lib/editor/ai/plugin/ai-capabilities'
import { EditorAiProvider } from '@/lib/editor/ai/plugin/editor-ai-context'
import { EditorDragHandle } from './core/drag-handle/editor-drag-handle'
import { TocSidebar } from './smart/document-outline/toc-sidebar'
import { HeadingWithId } from './core/formatting/extensions/heading-id'
import { TocBlock } from './smart/document-outline/extensions/toc-block'
import { TocTemplateModal } from './smart/document-outline/toc-template-modal'
import { AutosaveIndicator } from './core/drag-handle/autosave-indicator'
import { SlashCommands } from './smart/slash-commands/slash-commands'
import { SmartPaste } from './smart/smart-paste/smart-paste'
import { MarkdownShortcuts } from './smart/markdown-shortcuts/extensions/markdown-shortcuts'
import { BlockShortcuts } from './smart/markdown-shortcuts/extensions/block-shortcuts'
import { EmptyLineHint } from './core/drag-handle/empty-line-hint'
import { CommandPalette } from './smart/slash-commands/command-palette'
import { AiAutocomplete } from './ai/autocomplete/extensions/ai-autocomplete'
import { useAiSpellcheck } from './smart/spell-check/extensions/ai-spellcheck'
import { AiGrammarCheck, useAiGrammarCheck } from './ai/grammar-check/extensions/ai-grammar-check'
import { useAiStore } from '@/lib/store/use-ai-store'
import { FontSize } from './core/formatting/extensions/font-size'
import { ResizableImage } from './core/images/extensions/resizable-image'
import { Callout } from './core/callouts/extensions/callout'
import { VideoEmbed } from './core/media/extensions/video-embed'
import { ChartBlock } from './smart/spark-chart/extensions/chart-block'
import { KpiRow } from './smart/spark-chart/extensions/kpi-row'
import { EditorComment } from './core/comments/extensions/editor-comment'
import { ListStyleExtension } from './core/lists/extensions/list-style'
import { BlockIndent } from './core/lists/extensions/block-indent'
import { AiLoadingMark } from './ai/shared/extensions/ai-loading-mark'
import { AskPrompt, AskAnswer } from './ai/ask/extensions/ask-blocks'
import { AiIssues } from './ai/find-issues/extensions/ai-issues-block'
import { useEditorDialogs } from './core/dialogs/use-editor-dialogs'
import { uploadsApi } from '@/lib/api/ai-client'
import { readImageFileAsDataUrl } from './core/images/editor-image-upload'
