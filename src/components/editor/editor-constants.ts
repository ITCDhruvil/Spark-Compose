...
export const EDITOR_SHORTCUTS = [
  ...
  { keys: '/', action: 'Slash commands (e.g. /table 3x3)' },
  { keys: '+', action: 'Insert block on empty line' },
  { keys: '# + Space', action: 'Heading 1–6 at line start' },
  { keys: '- + Space', action: 'Bullet list at line start' },
  { keys: '1. + Space', action: 'Numbered list at line start' },
  { keys: '[] + Space', action: 'Checklist at line start' },
  { keys: '> + Space', action: 'Blockquote at line start' },
  ...
  { keys: 'Ctrl+Alt+1–6', action: 'Heading 1–6' },
  { keys: 'Ctrl+Shift+H', action: 'Highlight' },
  { keys: 'Ctrl+\\', action: 'Clear formatting' },
  { keys: 'Ctrl+Shift+P', action: 'Command palette' },
  { keys: 'Ctrl+Shift+↑ / ↓', action: 'Move block up / down' },
  { keys: 'Ctrl+Shift+D', action: 'Duplicate block' },
  { keys: 'Ctrl+Shift+Backspace', action: 'Delete block' },
  { keys: 'Ctrl+Alt+T', action: 'Insert table (last size)' },
] as const
