...
import { TOC_TEMPLATES, type TocTemplateId } from '@/lib/editor/smart/document-outline/toc-templates'
import { useTocStore } from '@/lib/store/use-toc-store'
import type { Editor } from '@tiptap/react'
import { applyTocTemplateToDocument } from '@/lib/editor/smart/document-outline/toc-utils'
