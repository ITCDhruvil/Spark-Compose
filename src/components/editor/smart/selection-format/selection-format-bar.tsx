...
} from '@/components/editor/core/formatting/editor-list-utils'
import {
  selectionLinesToTable,
  selectionToList,
  transformSelectionCase,
  wrapSelectionInCallout,
} from '@/lib/editor/core/formatting/selection-transforms'
...
/** Selection bubble with formatting only ΓÇö used when Spark AI is disabled. */
